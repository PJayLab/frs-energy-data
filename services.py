...
async def import_service_connections(raw_entries: list[dict], session: AsyncSession):
    ...
    for entry in raw_entries:
        ...
        service_connection = ServiceConnection(
            ...
            object_name=entry.get("object") or entry.get("objekt") or object_display_name,
            insurance_number=entry.get("insurance_number") or entry.get("assek_nr"),
            unswitched_terminal=entry.get("unswitched_terminal") or entry.get("tk_ohne_schalt"),
            first_disconnect_point_name=entry.get("first_disconnect_point") or entry.get("erste_trennstelle"),
            source_name=entry.get("source_name") or entry.get("speisung"),
